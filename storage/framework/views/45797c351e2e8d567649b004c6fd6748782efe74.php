<div class="card">
    ...
    <div class="card-body card-padding">
        <?php if($data['status'] === \Canvas\Helpers\CanvasHelper::MAINTENANCE_MODE_DISABLED): ?>
            <form class="form-inline" action="<?php echo route('canvas.admin.tools.enable_maintenance_mode'); ?>" method="POST">
        ...
        <?php else: ?>
            <form class="form-inline" action="<?php echo route('canvas.admin.tools.disable_maintenance_mode'); ?>" method="POST">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
