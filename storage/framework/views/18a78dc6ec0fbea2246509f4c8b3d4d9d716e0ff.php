...
<p>
    ...
    menu item in the sidebar, and then clicking <a href="<?php echo route('canvas.admin.tag.create'); ?>">Add New</a>.
...
<p>
    Assigning a tag to a specific blog post is easy. Just go to the <a href="<?php echo route('canvas.admin.post.index'); ?>">Posts</a> page and click the <span class="zmdi zmdi-edit text-primary"></span> action
...
<p>
    To delete a tag, go to the <a href="<?php echo route('canvas.admin.tag.index'); ?>">Tags</a> page and click the <span class="zmdi zmdi-edit text-primary"></span> action on a specific tag.
