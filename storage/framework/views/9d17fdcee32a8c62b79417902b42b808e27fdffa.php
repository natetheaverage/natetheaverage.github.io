<?php $__env->startSection('title'); ?>
    <title><?php echo e(\Canvas\Models\Settings::blogTitle()); ?> | Forgot Password</title>
...
<?php $__env->startSection('login'); ?>
    <div class="login-container">
        ...
        <?php echo $__env->make('canvas::auth.passwords.partials.email-form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('unique-js'); ?>
    <?php echo JsValidator::formRequest('Canvas\Http\Requests\ForgotPasswordRequest', '#forgot-password'); ?>
