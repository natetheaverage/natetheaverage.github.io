...
exports['default'] = {
    ...
    ready: function ready() {
        ...
        var that = this;
        this.$http.get('http://api.behance.net/v2/users/natetheaverage/projects?client_id=OYlVWtJWfgjkrpRxNT0hODcsG3oLw3S1', function (json) {
            console.log(json);
        });
    }
};
...
},{"./app":77,"vue":75,"vue-resource":3}]},{},[78]);
